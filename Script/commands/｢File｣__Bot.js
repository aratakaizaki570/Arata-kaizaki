...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "") || (event.body.toLowerCase() == "") ||(event.body.toLowerCase() == "") || (event.body.toLowerCase() == "hi")) {
  ...
  if ((event.body.toLowerCase() == "") || (event.body.toLowerCase() == "") || (event.body.toLowerCase() == "@Arara Kaizaki ッ") || (event.body.toLowerCase() == "Rohit")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Arata ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Rohit.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :-https://www.facebook.com/share/19CHrrWkd1/তার সাতে যোগা যোগ করবেন WhatsApp :- ", threadID);
   };

   if ((event.body.toLowerCase() == "") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:Arata kaizaki ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস রিহত আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "")) {
     return api.sendMessage("He is Arata ッ❤️ তাকে সবাই রহিত নামে  চিনে🤙", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "chup") || (event.body.toLowerCase() == "") || (event.body.toLowerCase() == "") || (event.body.toLowerCase() == "")) {
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == " ")) {
   ...
   if ((event.body.toLowerCase() == "@Yumisoki haroka") || (event.body.toLowerCase() == "@Yumisoki Haroka ")) {
  ...
  if ((event.body.toLowerCase() == "@Yuta okkotsu ") || (event.body.toLowerCase() == "নাদিম")) {
   ...
   if ((event.body.toLowerCase() == "") || (event.body.toLowerCase() == "Hum")) {
     return api.sendMessage("️হুম চোদাইস না মাথা এমনিতেই গরম আছে🤬⛏️😷", threadID);
   };

   if ((event.body.toLowerCase() == "") || (event.body.toLowerCase() == "") || (event.body.toLowerCase() == "Tor nam ki")) {
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "") || (event.body.toLowerCase() == "") || (event.body.toLowerCase() == "") || (event.body.toLowerCase() == "")) {
     ...
     if ((event.body.toLowerCase() == "") || (event.body.toLowerCase() == "Bye") || (event.body.toLowerCase() == "") || (event.body.toLowerCase() == "") || (event.body.toLowerCase() == "") || (event.body.toLowerCase() == "")) {
