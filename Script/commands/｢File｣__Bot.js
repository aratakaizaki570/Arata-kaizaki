...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "") || (event.body.toLowerCase() == "") || (event.body.toLowerCase() == "@Arara Kaizaki ッ") || (event.body.toLowerCase() == "Rohit")) {
   ...
   if ((event.body.toLowerCase() == "") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:Arata kaizaki ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস উল্লাস আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };
